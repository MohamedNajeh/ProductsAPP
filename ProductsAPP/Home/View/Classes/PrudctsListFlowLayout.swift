...
protocol ProductsListLayoutDelegate: AnyObject {
    func collectionView(
        _ collectionView: UICollectionView,
        heightForPhotoAtIndexPath indexPath: IndexPath) -> Int
}

class PrudctsListFlowLayout: UICollectionViewFlowLayout {
    
    // 1
    weak var delegate: ProductsListLayoutDelegate?
    
    // 2
    private let numberOfColumns = 2
    private let cellPadding: Int = 0
